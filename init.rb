...
require File.join(common_path, 'active_record_extensions', 'mixin.rb')
require File.join(common_path, 'active_record_extensions', 'sdata_uuid_mixin.rb')
require File.join(common_path, 'active_record_extensions', 'base.rb')
...
require File.join(common_path, 'resource.rb')
