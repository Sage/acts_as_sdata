...
require ~'lib/s_data/virtual_base/virtual_base'
require ~'lib/s_data/virtual_base/scoped_virtual_base'
...
require ~'lib/s_data/resource/scoping.rb'
require ~'lib/s_data/resource/scope.rb'
