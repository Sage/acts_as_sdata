  ...
  module Application
    module Actions
      def sdata_collection
        collection_feed = SData::Collection::Feed.new(sdata_resource, collection_scope, pagination, feed_links, context)
      ...
      def context
        @context ||= SData::Application::Context.new(params, query_params)
      end
